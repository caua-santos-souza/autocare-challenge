    ...
    return (
        <div className={styles.faq} id='faq'>
            ...
            <ItemFAQ 
                ...
                resposta="Para iniciar o uso do Autocare, primeiro, crie uma conta acessando nosso site ou aplicativo e realizando o cadastro. Em seguida, informe os dados do seu veículo adicionando as informações básicas sobre o seu carro. Descreva os problemas ou sintomas que você está enfrentando com o veículo para que o sistema possa analisá-los."
            />
            <ItemFAQ 
            ...
            <ItemFAQ 
                ...
                resposta="O Autocare integra-se ao seu veículo principalmente através das informações que você fornece manualmente sobre problemas ou alertas que o carro está apresentando."
            />
            <ItemFAQ 
                pergunta="Como atualizo minhas informações?" 
                resposta="Para atualizar suas informações, faça login na sua conta no nosso site ou aplicativo e vá até a seção de perfil ou configurações."
            />
        </div>
    );
};
